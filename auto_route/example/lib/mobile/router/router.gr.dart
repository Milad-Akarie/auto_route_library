...
class RootRouter extends _i12.RootStackRouter {
    ...
    HomeRoute.name: (routeData) {
      return _i12.MaterialPageX<String>(
        ...
        child: _i12.DeferredWidget(
          _i1.loadLibrary,
          () => _i12.WrappedRoute(child: _i1.HomePage()),
        ),
      );
    },
  ...
  List<_i12.RouteConfig> get routes => [
        ...
        _i12.RouteConfig(
          UserDataCollectorRoute.name,
          path: '/user-data',
          children: [
            _i12.RouteConfig(
              NameFieldRoute.name,
              path: 'name',
              parent: UserDataCollectorRoute.name,
            ),
            _i12.RouteConfig(
              FavoriteBookFieldRoute.name,
              path: 'favorite-book',
              parent: UserDataCollectorRoute.name,
            ),
            _i12.RouteConfig(
...
class UserDataCollectorRoute
  ...
  UserDataCollectorRoute({
    ...
    List<_i12.PageRouteInfo>? children,
          ...
          UserDataCollectorRoute.name,
          path: '/user-data',
          args: UserDataCollectorRouteArgs(
            key: key,
            onResult: onResult,
          ),
          initialChildren: children,
...
class UserDataCollectorRouteArgs {
  const UserDataCollectorRouteArgs({
    this.key,
    this.onResult,
  });
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is UserDataCollectorRouteArgs &&
            this.key == other.key &&
            this.onResult == other.onResult);
  }

  @override
  int get hashCode {
    return Object.hashAll([key.hashCode, onResult.hashCode]);
  }
}
...
class LoginRouteArgs {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is LoginRouteArgs &&
            this.key == other.key &&
            this.onLoginResult == other.onLoginResult &&
  ...
  int get hashCode {
    return Object.hashAll(
        [key.hashCode, onLoginResult.hashCode, showBackButton.hashCode]);
  }
}
...
class SettingsTabArgs {
  ...
  @override
  int get hashCode {
    return Object.hashAll([key.hashCode, tab.hashCode, query.hashCode]);
  }
}
...
class BookDetailsRouteArgs {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is BookDetailsRouteArgs && this.id == other.id);
  }

  @override
  int get hashCode {
    return Object.hashAll([id.hashCode]);
  }
}
...
class MyBooksRouteArgs {
  ...
  @override
  int get hashCode {
    return Object.hashAll([key.hashCode, filter.hashCode]);
  }
}
...
class NameFieldRouteArgs {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is NameFieldRouteArgs &&
            this.key == other.key &&
            this.message == other.message &&
            this.willPopMessage == other.willPopMessage &&
            this.onNext == other.onNext);
  }
...
class FavoriteBookFieldRouteArgs {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is FavoriteBookFieldRouteArgs &&
            this.key == other.key &&
            this.message == other.message &&
            this.willPopMessage == other.willPopMessage &&
            this.onNext == other.onNext);
