...
void main() {
  ...
  test(
      'Calling Parameters.getString on a string value should return a <string>',
      () {
    const params = Parameters({'key': 'str'});
  ...
  test(
      'Calling Parameters.optString on a string value should return a <string> and null on a none existing value',
      () {
    const params = Parameters({'key': 'str'});
  ...
  test(
      'Calling Parameters.optInt on an int value should return a <int> and null on a none existing value',
      () {
    const params = Parameters({'key': '12'});
  ...
  test(
      'Calling Parameters.optDouble on a double value should return a <double> and null on a none existing value',
      () {
  ...
  test(
      'Calling Parameters.optNum on a double value should return a <num> and null on a none existing value',
      () {
    const params = Parameters({'key': '12.1'});
  ...
  test(
      'Calling Parameters.getDouble on a double value should return a <double>',
      () {
    const params = Parameters({'key': '12.5'});
    expect(params.getDouble('key'), isA<double>());
  });
  ...
  test(
      'Calling Parameters.getBool on "true" or "True" string value should return true',
      () {
  ...
  test(
      'Calling Parameters.optBool on a true-string value should return a <bool> and null on a none existing value',
      () {
  ...
  test(
      'Calling Parameters.getBool on "false" or "False" string value should return false',
      () {
  ...
  test(
      'Adding two Parameters together should create a new Parameters instance with both keys and values ',
      () {
    final allParams = const Parameters({'key1': 'value1'}) +
        const Parameters({'key2': 'value2'});
