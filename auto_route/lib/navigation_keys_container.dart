...
class NavigationKeysContainer {
  // ensure we only have one instance of the container
	static final NavigationKeysContainer _instance = NavigationKeysContainer._internal();
  ...
  GlobalKey<NavigatorState> get<T>() {
    // initiate keys lazily
	  return _navigatorKeys[T] ??= GlobalKey<NavigatorState>(debugLabel: T.toString());
  }
}
